...
const pool = new Pool({
    connectionString: (process.env.EXTERNAL_DATABASE_URL || process.env.DATABASE_URL).replace('db.sgcoecupsaljigypcoer.supabase.co', 'aws-0-us-east-1.pooler.supabase.com').replace(':5432/', ':6543/').replace('postgres:', 'postgres.sgcoecupsaljigypcoer:'),
    ssl: { 
